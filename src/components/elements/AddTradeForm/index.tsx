...
import { ERC20, IERC20, TrustMe } from "typechain";
...
export default function AddTradeForm() {
    const [sellerTokenMetadata, setSellerTokenMetadata] = React.useState<
        TokenMetadata[]
    >([]);
        ...
        <FormWrapper title="Seller Token Details">
            ...
            <>
                ...
                <input
                    ...
                    onChange={(e) =>
                        updateFields({ sellerTokenAmount: e.target.value })
                    }
                    className="p-2 rounded w-full"
                />
            </>
    ...
    async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        const _trustMeContract: TrustMe = await trustMeContract();
        const _erc20Contract: ERC20 = await erc20Contract(
        ...
        await _tx.wait();
        console.log(_trustMeContract);
        const tx = await _trustMeContract.addTrade(
            formData.buyerAddress,
            formData.sellerTokenAddress,
        ...
        <div>
            ...
            >
                <div className="w-[500px] h-[470px] bg-text rounded-md flex flex-col border-[1px] px-[15px]">
                    ...
                    <h3 className="py-5 text-center font-bold text-lg">
